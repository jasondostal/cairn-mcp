...
# ============================================================
# Cairn Narrative Prompts — removed in v0.37.0
# Kept as stubs for backward compatibility with any imports.
# ============================================================
...
def build_cairn_narrative_messages(
    ...
    """Deprecated in v0.37.0. Cairn narratives no longer synthesized."""
    raise NotImplementedError("Cairn narratives removed in v0.37.0 — use trail() for boot orientation")
